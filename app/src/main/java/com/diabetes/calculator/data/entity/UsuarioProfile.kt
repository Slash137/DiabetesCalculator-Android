...
data class UsuarioProfile(
    ...
    val nightscoutLinkOffsetUnits: Float = 1f,
    val libreviewSyncActivo: Boolean = true,
    val libreviewRegionOverride: String? = null,
    val libreviewBackfillDoneAt: Long? = null,
